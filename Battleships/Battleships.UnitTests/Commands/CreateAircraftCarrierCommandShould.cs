...
{
    [TestClass]
    public class CreateAircraftCarrierCommandShould
    {
        [TestMethod]
        public void SetTheFieldFactory()
        {
            ...
            var mockFactory = new FakeCreateAircraftCarrierCommand(fakeFactory.Object, fakeEngine.Object);
            //Act & Assert
        ...
        public void ThrowsArgumentExWithTheRightMessageIfInvalidParamatersArePassed()
        {
            var fakeFactory = new Mock<IBattleShipFactory>();
            var fakeEngine = new Mock<IEngine>();
            var command = new CreateAircraftCarrierCommand(fakeFactory.Object,fakeEngine.Object);
