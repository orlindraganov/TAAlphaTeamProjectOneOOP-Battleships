...
{
    public sealed class BattleShipsEngine : IEngine
    {
        private static readonly IEngine SingleInstance = new BattleShipsEngine();

        private BattleshipsFactory factory;
        private View view;
        //private ICollection<IUser> users;
        //private IUser loggedUser;

        private BattleShipsEngine()
        {
            // The factory should create 
            this.factory = new BattleshipsFactory();
            this.view = new View();
     ...
     /* TODO an implement of the BoardGame!
